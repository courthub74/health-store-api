...
class ProductSerializer(serializers.ModelSerializer):
	...
	sale_start = serializers.DateTimeField(
		required=False, #Makes field optional (for tests sake)
	...
	#Override update method to make use of warranty field
	...
	#Create Method(TEST for the 'warranty' error)
	def create(self, validated_data):
		validated_data.pop('warranty')
		return Product.objects.create(**validated_data)

#TEST for Product Destroy
# class test_delete_product(self):
...
class ProductStatSerializer(serializers.Serializer):
    ...
    #Modification of serialized representation and add extra fields
