...
class ProductList(ListAPIView):
    queryset = Product.objects.all() #creating a queryseto of all Products that exist in the dataset
...
class ProductRetrieveUpdateDestroy(RetrieveUpdateDestroyAPIView):
    ...
    #Freeup Cache space for maximum performance with 'Delete' method
